    ...
    return (
        <Link href={`/article/${slug}`}>
            <div className="grid place-items-center max-w-xl w-full mx-auto">
                <div className='shadow-xl font-jkt rounded-2xl w-full bg-white flex flex-col lg:flex-row px-5 py-6 gap-4 border-blue-950 border-solid border-2'>
                    <div className="align-middle w-full lg:w-1/3 h-28 bg-zinc-300 rounded-2xl relative border-gray-300 border-2">
